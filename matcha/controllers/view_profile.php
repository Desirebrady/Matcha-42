...
<br>
<?php 
foreach ($viewProfile as $profile) ?>

  <div>

  <img src="uploads/profile_pic/<?php echo $profile['profile_pic']?>" width="500px"height="599px" ><br>
firstname : <?php echo $profile['firstname']; ?><br>
lastaname : <?php echo $profile['lastname']; ?><br>
bio <?php echo $profile['bio']; ?>
   <br>
   Sex : <?php echo $profile['gender']; ?><br>
   Age : <?php echo $profile['age']; ?><br>
   lastseen : <?php echo $profile['lastseen']; ?> <br>
