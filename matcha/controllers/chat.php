...
<h2 class="card-heading"><h2>Chatting to : <?php echo $image['firstname']." ".$image['lastname'];?></h2>
<?php endforeach; ?>
...
<form method="post">
        ...
        <textarea id="message" name="message"  placeholder="say something..." style="width: 400px;
    height: 50px;"
 ></textarea>
        </div>
        <div class="wthree-field">
