      ...
      <ul class="sf-menu" id="example">
        ...
        <li class="current"> <a href="#">Match</a>
          <ul>
            ...
            <li class="current" style="color: white"> <a href="matchAge.php">By Age</a></li>
            <li class="current" style="color: white"> <a href="matchLocation.php">By location</a></li>
          </ul>
        </li>
        <li class="current"> <a href="">Action</a>
          <ul>
            <?php if (!empty($_SESSION['username'])) : ?>
              <li class="current" style="color: white"><a href="../admin/logout.php" style="color: red;">Goodbye</a></li>
            <?php endif; ?>
          </ul>
        </li>
      </ul>
