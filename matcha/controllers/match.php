...
<h2><p> Showing users closer to you and opposite to your gender, click their image to view more about them</p></h2>
<div class="wrap5">
 <?php foreach ($results as $result)
 {
   
    // $dist = round(distance($result['lat'], $result['lon'], isset($_SESSION['lat']), isset($_SESSION['lon'])));
    if ($result['username'] != $_SESSION['username'] && isset($_SESSION['gender']) != result['gender'] && !is_blocked($_SESSION['username'], $result['username']) && isset($_SESSION['username']))
    {
  ?>
<div class="card">
