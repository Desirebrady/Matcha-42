...
$allusers = mysqli_query($db, "SELECT * FROM users where gender != '$myGender' LIMIT " . $start_limit . ',' . $users_per_page);
$results = mysqli_fetch_all($allusers, MYSQLI_ASSOC);
	...
	<div class="container-fluid">
		<div class="row" style="margin-top: 7%">
			<div class="" style="margin-left: 13%;">
				<h2>
					<p style=" color: white;"> Showing users opposite to your gender, click their image to view more about them</p>
				</h2>
				...
				?>
						<div class="card zoom">
							...
							<div class="row">
								...
								<div class="col">
									<p class="title"><?php echo $result['gender']; ?></p>
								</div>
							</div>
							<?php
							$user = $_SESSION['username'];
				...
				<div>
					...
					if ($page < $number_of_pages && $page > 1) {
						echo	'<div class="pagination">
									<a style="color: #14FFFF;" href="match.php?page=' . $prev . '">' .  '❮' . '</a>';
					...
					if ($page == 1 && $number_of_pages != 1) {
						$next = $page + 1;
						echo	'<div class="pagination">
									<a style="color: #14FFFF;" href="match.php?page=' . $next . '">' .  '❯' . '</a> 
								</div>';
					}
					?>
				</div>
